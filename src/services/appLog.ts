...
const createLog = async (data: { [key: string | number]: any }) => {
    try {
        const appLog = await axios.post(`${API_URL}/api/appLog/create`, data, getConfig())
        return appLog.data
    } catch (err) { console.log(err) }
}
...
const updateLog = async (data: { [key: string | number]: any }) => {
    try {
        const appLog = await axios.post(`${API_URL}/api/appLog/update`, data, getConfig())
        return appLog.data
    } catch (err) { console.log(err) }
}
...
const deleteLog = async (data: { [key: string | number]: any }) => {
    try {
        const deleted = await axios.post(`${API_URL}/api/appLog/remove`, data, getConfig())
        return deleted.data
    } catch (err) { console.log(err) }
}
